...
cv_results = cross_validate_epsilon(data, epsilons=[0.0, 0.05, 0.1, 0.2], kfolds=5, metric="cindex")
...
- Check the [scikit-learn API guide](sklearn_api.md) for pipelines and grid search
